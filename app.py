# Import Flask untuk membuat aplikasi web
from flask import Flask, render_template, request, redirect, url_for, session

# Import modul pandas untuk bekerja dengan data Excel
import pandas as pd
...
# Set kunci rahasia untuk sesi (gantilah 'your_secret_key' dengan kunci rahasia yang kuat dan unik)
app.secret_key = 'your_secret_key'

# Data pengguna untuk keperluan contoh
users_data = {
    'diyan': {'password': 'wicak', 'name': 'Diyan'},
    'lintang': {'password': '123', 'name': 'Lintang'},
    'fitri': {'password': '123', 'name': 'Fitri'},
